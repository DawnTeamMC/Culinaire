...
public final class CauldronUtil {
    ...
    public static void addBottleInteractions(CauldronBehavior.CauldronBehaviorMap map, Block cauldron, Item bottle) {
        ...
        map.map().put(Items.GLASS_BOTTLE, CauldronInteractionBuilder.create().addLevel(-1).item(bottle).sound(SoundEvents.ITEM_BOTTLE_FILL).build()); // Fill bottle from cauldron
    }

    public static void addBucketInteractions(CauldronBehavior.CauldronBehaviorMap map, Block cauldron, Item bucket) {
        ...
        map.map().put(Items.BUCKET, CauldronInteractionBuilder.create().addLevel(-3).item(bucket).sound(SoundEvents.ITEM_BUCKET_FILL).build()); // Fill bucket from cauldron
    }
}