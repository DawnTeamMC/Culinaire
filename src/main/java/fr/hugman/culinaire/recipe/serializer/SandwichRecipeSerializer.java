package fr.hugman.culinaire.recipe.serializer;

import com.google.common.collect.Maps;
import com.google.gson.JsonArray;
import com.google.gson.JsonObject;
import fr.hugman.culinaire.recipe.SandwichRecipe;
import fr.hugman.culinaire.util.RecipeSerializerUtil;
...
public class SandwichRecipeSerializer implements RecipeSerializer<SandwichRecipe> {
    ...
    public SandwichRecipe read(Identifier id, JsonObject json) {
        ...
        ItemStack resultStack = new ItemStack(Registries.ITEM.get(Identifier.of(JsonHelper.getString(json, "result"))), resultCount);
