...
public final class CulinaireComponentTypes {
    ...
    public static final ComponentType<TeaTypesComponent> TEA_TYPES = register("tea_types", builder -> builder.codec(TeaTypesComponent.CODEC).packetCodec(TeaTypesComponent.PACKET_CODEC));
