...
import fr.hugman.culinaire.item.TeaBottleItem;
...
public class TeaContent {
	...
	public static final Block KETTLE = new KettleBlock(DawnBlockSettings.create().mapColor(MapColor.IRON_GRAY).requiresTool().strength(5.0F, 1200.0F).sounds(BlockSoundGroup.STONE).pistonBehavior(PistonBehavior.BLOCK).item());
