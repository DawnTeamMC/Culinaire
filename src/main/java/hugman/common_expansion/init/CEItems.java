...
public class CEItems {
	...
	public static final Item SALAD = register("salad", new Item(new Item.Settings().group(ItemGroup.FOOD)));
	public static final Item MASHED_POTATOES = register("mashed_potatoes", new Item(new Item.Settings().group(ItemGroup.FOOD)));
