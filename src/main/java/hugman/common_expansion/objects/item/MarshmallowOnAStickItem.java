...
public class MarshmallowOnAStickItem extends Item {
	...
	public int getDefaultMaxBurnTime(Item item) {
		if(item == CEItems.UNCOOKED_MARSHMALLOW_ON_A_STICK) {
			return 150;
		}
		else if(item == CEItems.TOASTY_MARSHMALLOW_ON_A_STICK) {
			return 75;
		}
		else if(item == CEItems.GOLDEN_MARSHMALLOW_ON_A_STICK) {
			return 20;
		}
		else if(item == CEItems.BURNT_MARSHMALLOW_ON_A_STICK) {
			return 30;
		}
		else {
			return 60;
	...
	public Item getDefaultBurnItem(Item item) {
		if(item == CEItems.UNCOOKED_MARSHMALLOW_ON_A_STICK) {
			return CEItems.TOASTY_MARSHMALLOW_ON_A_STICK;
		}
		else if(item == CEItems.TOASTY_MARSHMALLOW_ON_A_STICK) {
			return CEItems.GOLDEN_MARSHMALLOW_ON_A_STICK;
		}
		else if(item == CEItems.GOLDEN_MARSHMALLOW_ON_A_STICK) {
			return CEItems.BURNT_MARSHMALLOW_ON_A_STICK;
		}
		else if(item == CEItems.BURNT_MARSHMALLOW_ON_A_STICK) {
			return Items.STICK;
		}
