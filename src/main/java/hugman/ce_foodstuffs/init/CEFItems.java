...
public class CEFItems extends CEFPack {
	...
	public static final Item MARSHMALLOW = register(new ItemCreator.Builder("marshmallow", new Item(new Item.Settings().group(ItemGroup.FOOD).food(CEFFoods.UNCOOKED_MARSHMALLOW))).setCompostingChance(0.3f));
