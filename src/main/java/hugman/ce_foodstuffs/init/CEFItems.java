...
public class CEFItems extends CEFPack {
	public static final Item CHEESE = register(new ItemCreator.Builder("cheese", new Item(new Item.Settings().group(ItemGroup.FOOD).food(CEFFoods.CHEESE))).setCompostingChance(0.5f));
	public static final Item LETTUCE = register(new ItemCreator.Builder("lettuce", new Item(new Item.Settings().group(ItemGroup.FOOD).food(CEFFoods.LETTUCE))).setCompostingChance(0.3f));
	public static final Item LETTUCE_SEEDS = register(new ItemCreator.Builder("lettuce_seeds", new AliasedBlockItem(CEFBlocks.LETTUCE, new Item.Settings().group(ItemGroup.MATERIALS))).setCompostingChance(0.3f));
	public static final Item TOMATO = register(new ItemCreator.Builder("tomato", new AliasedBlockItem(CEFBlocks.TOMATOES, new Item.Settings().group(ItemGroup.FOOD).food(CEFFoods.TOMATO))).setCompostingChance(0.3f));
	public static final Item CHOCOLATE = register(new ItemCreator.Builder("chocolate", new Item(new Item.Settings().group(ItemGroup.FOOD).food(CEFFoods.CHOCOLATE))).setCompostingChance(0.3f));
	public static final Item MARSHMALLOW = register(new ItemCreator.Builder("marshmallow", new Item(new Item.Settings().group(ItemGroup.FOOD).food(CEFFoods.MARSHMALLOW))).setCompostingChance(0.3f));
	public static final Item CHOUQUETTE = register(new ItemCreator.Builder("chouquette", new Item(new Item.Settings().group(ItemGroup.FOOD).food(CEFFoods.CHOUQUETTE))).setCompostingChance(0.3f));
	public static final Item APPLE_PIE = register(new ItemCreator.Builder("apple_pie", new Item(new Item.Settings().group(ItemGroup.FOOD).food(CEFFoods.APPLE_PIE))).setCompostingChance(1.0f));
	public static final Item SWEET_BERRY_PIE = register(new ItemCreator.Builder("sweet_berry_pie", new Item(new Item.Settings().group(ItemGroup.FOOD).food(CEFFoods.SWEET_BERRY_PIE))).setCompostingChance(1.0f));
	...
	public static final Item SANDWICH = register(new ItemCreator.Builder("sandwich", new SandwichItem(new Item.Settings().group(ItemGroup.FOOD).food(CEFFoods.SANDWICH_BASE).maxCount(1))).setCompostingChance(1.0f));
