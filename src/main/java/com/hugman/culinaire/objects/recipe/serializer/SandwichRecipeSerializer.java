...
public class SandwichRecipeSerializer implements RecipeSerializer<SandwichRecipe> {
	...
	public SandwichRecipe read(Identifier id, JsonObject json) {
		...
		return new SandwichRecipe(id, bread, ingredientBlacklist, hungerModifierBase, hungerModifierBoosted, saturationModifierBase, saturationModifierBoosted, ingredientAssociations, resultStack);
	}
