...
public class TeaBrewingCategory implements DisplayCategory<TeaBrewingDisplay> {
    ...
    public List<Widget> setupDisplay(TeaBrewingDisplay display, Rectangle bounds) {
        ...
        widgets.add(Widgets.createDrawableWidget((context, mouseX, mouseY, delta) -> {
            ...
            // main texture
            context.drawTexture(texture, startPoint.x, startPoint.y, 0, 0, 70, 60);
            ...
            context.drawTexture(texture, startPoint.x + 1, startPoint.y + 32, 70, 0, 46, 16);
            RenderSystem.setShaderColor(1.0F, 1.0F, 1.0F, 1.0F);

            // fire texture
            context.drawTexture(texture, startPoint.x + 12, startPoint.y + 52, 70, 16, 24, 9);
