...
public class CulinaireFoodBundle extends CulinaireBundle {
	...
	public static final BlockEntityType<MilkCauldronBlockEntity> MILK_CAULDRON_ENTITY = add(new BlockEntityCreator<>("milk_cauldron", FabricBlockEntityTypeBuilder.create(MilkCauldronBlockEntity::new, MILK_CAULDRON)));
