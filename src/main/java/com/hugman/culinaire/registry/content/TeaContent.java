...
public class TeaContent {
    ...
    public static final Block KETTLE = new KettleBlock(FabricBlockSettings.of(Material.METAL, MapColor.IRON_GRAY).requiresTool().strength(5.0F, 1200.0F).sounds(BlockSoundGroup.STONE));
